...
def check_headers(url):
    ...
    try:
        ...
        if "X-Powered-By" in headers:
            print(f"Warning: X-Powered-By header found: {headers['X-Powered-By']}. Remove to reduce information leakage.")
...
def scan_ports(target):
    ...
    try:
        nm.scan(target, arguments="-sS -p 80,443,22,21,3306")  # Scan common ports
